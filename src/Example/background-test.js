class Example extends Phaser.Scene
{
    ...
    create ()
    {
        ...
        const bg = this.add.group({key: 'star', frameQuantity: 300});
        ...
        const rect = new Phaser.Geom.Rectangle(0, -2 * this.h, this.w, 2 * this.h);
    ...
    update (time, delta)
    {
        ...
        const hexColor = Phaser.Display.Color.Interpolate.ColorWithColor(this.sky, this.space, -this.h * 2, this.player.y);
